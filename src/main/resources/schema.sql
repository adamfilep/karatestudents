...
create table student_training_list
(
    student_id       bigint not null,
    training_list_id bigint not null
);
...
alter table if exists student_training_list
    add constraint FKaolr35abeabmqawoy4rcb2fmq
    foreign key (training_list_id)
    references training
    Hibernate:

alter table if exists student_training_list
    add constraint FKewo4bne4vjibhlg48j5eg8kpt
